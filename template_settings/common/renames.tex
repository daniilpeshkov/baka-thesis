...
%%
%%
\renewcommand{\thesisTitle}{Разработка управляющего устройства калибратора суб-наносекундной синхронизации}
...
%%
%%
\newcommand{\group}{3530101/80101} % заменить вместо N номер группы
